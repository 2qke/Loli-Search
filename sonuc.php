...
<div class="container">
            ...
            <div class="form">
                <form method="get" action="sonuc.php">
                    ...
                    <span class="sol-taraf">
                                <a href="index.php" class="text-black"><i class="bi-house"></i></a>
                        </span>
                </form>
            </div>
        </div>
    ...
    <div class="nav justify-content-center mb-3">
                    ...
                    ';
                        ...
                        while($cikti2 = $link_kontrol->fetch(PDO::FETCH_ASSOC)){
                            if($cikti2['user_link_anime'] == $cikti['user_card_title']){
                                echo '<a href="' . $cikti2['user_link_link'] . '"><div class="btn btn-outline-white" style="border-radius: 100px; margin-left: 3px;" data-ripple-color="dark">' . $cikti2['user_link_name'] . '</div></a></div>';
                            }
                        }
                    }
                }
        ...
        <div class="col-md-12 text-center">
            ...
            <div class="card col-md-7 f-left" style="background-color: #3c3c3c; margin-left: -3px; max-width: 700px;">
...
<ul class="nav nav-pills mb-3 justify-content-center" id="ex1" role="tablist">
            ...
            >
                ...
                <div class="card text-white" style="background: #3c3c3c">
